    ...
    if (min_price!=0) {
        if (max_price!=0) {
            if (min_price<max_price) {
                filter["property_price"] = {"$gt": min_price, "$lt": max_price}
            }
        } else {
            filter["property_price"] = {"$gt": min_price}
        }
    } else {
        if (max_price!=0) {
            filter["property_price"] = {"$lt": max_price}
        }
    }
    ...
    if (min_area!=0) {
        if (max_area!=0) {
            if (min_area<max_area) {
                filter["property_area"] = {"$gt": min_area, "$lt": max_area}
            }
        } else {
            filter["property_area"] = {"$gt": min_area}
        }
    } else {
        if (max_area!=0) {
            filter["property_area"] = {"$lt": max_area}
        }
    }
    sort = {};
